export default {
  ...
  glosario: [
    ...
    },
    {
      ...
      significado:
        'Esta es una aplicación (app) que te permite pagar desde tu celular sin llevar las tarjetas contigo, de forma más fácil y segura, en comercios con datáfonos habilitados. Para hacer uso de esta tecnología debes descargar la aplicación en tu Smartphone, crear una cuenta e inscribir las tarjetas',
    },
    {
